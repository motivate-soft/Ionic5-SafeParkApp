...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-login-login-module"], {
  ...
  function srcAppAuthLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var LoginPage = /*#__PURE__*/function () {
      function LoginPage(formBuilder, navCtrl, // public admobFree: AdMobFree, 
      authService, router, loadingCtrl, toastCtrl) {
        ...
        this.loginForm = this.formBuilder.group({
          username: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required // Validators.minLength(6),
          // Validators.maxLength(20)
          // Validators.pattern('^[a-zA-Z0-9_.+-]+$')
          ])),
          password: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('', _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required // Validators.minLength(6),
          // Validators.maxLength(20)
      ...
      _createClass(LoginPage, [{
        key: "ngOnInit",
        value: function ngOnInit() {} // goSignup()
        // {
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    loading.present();
                    this.authService.login(this.loginForm.value).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["finalize"])(function () {
        ...
        value: function showInterstitialAds() {// let interstitialConfig: AdMobFreeInterstitialConfig = {

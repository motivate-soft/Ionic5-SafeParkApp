...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ProfilePage = /*#__PURE__*/function () {
      function ProfilePage(alertController, modalCtrl, authService, router, navCtrl, userService, alertCtrl, translate, loadingCtrl, toastCtrl) {
                  ...
                  case 3:
                    ...
                    return this.alertCtrl.create({
                      ...
                      buttons: [{
                        ...
                        text: 'Confirm',
                        handler: function handler(data) {
                          if (data['email'] == _this2.email) {
                            _this2.userService.updateProfile(obj).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {})).subscribe(function (_) {
                              if (JSON.parse(_)['success']) {
                                _this2.navCtrl.navigateRoot(['login'], {
                                  replaceUrl: true
                                });
                              } else _this2.handleError('Invalid Credentials');
                            }, function (err) {
                              console.log(err);
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"], _auth_auth_service__WEBPACK_IMPORTED_MODULE_7__["AuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _api_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["AlertController"], _ngx_translate_core__WEBPACK_IMPORTED_MODULE_5__["TranslateService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["LoadingController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ToastController"]])], ProfilePage);
    /***/
  }
}]);

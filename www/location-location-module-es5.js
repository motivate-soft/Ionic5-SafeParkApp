...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["location-location-module"], {
  ...
  function srcAppLocationLocationPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _providers_map_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    /*! ../providers/map/map */
    ...
    /*! ../api/user.service */
    "./src/app/api/user.service.ts"); // Environment
    //Service
    ...
    var LocationPage = /*#__PURE__*/function () {
      ...
      // currentPlateNo: any;
      // currentPhone: any;
      function LocationPage(map, userService, navCtrl) {
      ...
      _createClass(LocationPage, [{
        ...
        value: function getTotalDevices() {
          ...
          this.userService.getTotalDevices().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {})).subscribe(function (res) {
            _this.initDevices = res;
            _this.totalDevices = _this.initDevices;

            _this.map.attachMap(_this.totalDevices, _this.mapId, {
              lat: 44.439195789225614,
              lng: 26.09365010309947
            });
          }, function (err) {
            console.log(err);
          });
        ...
        value: function displayMap() {
          ...
          var tmpDevices = this.initDevices;
          this.userService.flag = false; // if the value is an empty string don't filter the items
          ...
          if (this.userService.currentLng == 0 && this.userService.currentLat == 0) {
            ...
            this.map.attachMap(this.totalDevices, this.mapId, {
              lat: this.currentLat,
              lng: this.currentLng
            });
            return true;
        ...
        key: "displayStreetView",
        value: function displayStreetView() {
          return true; // if(this.userService.currentLng == 0 && this.userService.currentLat == 0)
          // {
          //   return true;
          // }
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_providers_map_map__WEBPACK_IMPORTED_MODULE_2__["MapProvider"], _api_user_service__WEBPACK_IMPORTED_MODULE_6__["UserService"], _ionic_angular__WEBPACK_IMPORTED_MODULE_3__["NavController"]])], LocationPage);
    /***/
  }
}]);
